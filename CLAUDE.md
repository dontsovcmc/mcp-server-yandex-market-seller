...
**Полные правила кода — в [development.md](development.md) (раздел "Правила безопасности и качества кода").** Ключевое:

- Пути для записи файлов — только через `_safe_path()` (home или /tmp).
